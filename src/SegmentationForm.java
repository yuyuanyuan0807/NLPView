 ...
 * @author  __USER__
 */
public class SegmentationForm extends javax.swing.JFrame {
...
//		this.setLocation(screenWidth / 2 - windowWidth / 2, screenHeight / 2 - windowHeight / 2);//设置窗口居中显示
		...
		setTitle("\u4e2d\u6587\u81ea\u7136\u8bed\u8a00\u5904\u7406\u5de5\u5177NLPView1.0\u2014\u2014\u4e2d\u6587\u5206\u8bcd                       By Yu Yuanyuan");
		...
		layout.setHorizontalGroup(layout
				...
				.addGroup(
						layout.createSequentialGroup()
								...
								.addComponent(jButton5).addGap(327, 327, 327))
				.addGroup(
	...
	private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {
		ChineseWordSegmentation cws = new ChineseWordSegmentation();
		...
		try {
			...
			if (str == "") {
				...
				jTextArea2.setText("");
				segmentation = cws.WordSegmentation(str);
				jTextArea2.append(segmentation);
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new SegmentationForm().setVisible(true);
			}
		});
	}
