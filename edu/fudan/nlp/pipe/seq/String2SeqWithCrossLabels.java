 ...
 *
 */
public class String2SeqWithCrossLabels extends Pipe implements Serializable {
	...
	public String2SeqWithCrossLabels(boolean b){
		hasLabel = b;
	}
	...
	public static String genSequence(String sent){
		...
		for(int j=0; j<sent.length(); j++) {
			...
			if(j==sent.length()-1)
				sb.append('\n');
			else if(tag[j]==CharType.HAN||tag[j]==CharType.PUN||tag[j]==CharType.BLANK){//当前是汉字或标点
				sb.append('\n');
